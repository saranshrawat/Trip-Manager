 ...
 {   return (
        <footer className="bg-neutral-900 text-center text-white">
            ...
            <div
                ...
                <p className="text-sm">
    © {new Date().getFullYear()} This site has been fully developed and is managed by <span className="font-semibold text-blue-400"><a className="text-white" href="https://github.com/saranshrawat"
                >Saransh Rawat</a></span>.
  </p>
